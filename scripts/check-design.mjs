...
for (const marker of ["buttonClassName(variant", 'size-9', 'max-sm:size-10', 'aria-label={label}', 'aria-describedby={tooltipId}', 'role="tooltip"', 'keyboardModality', "matches(':focus-visible')", 'tooltipOpen ?', 'busy || undefined']) {
