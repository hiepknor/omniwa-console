...
for (const required of ["readOptionalSearchParam(searchParams, 'cursor')", "readOptionalSearchParam(searchParams, 'messageCursor')", "readOptionalSearchParam(searchParams, 'message')", "readOptionalSearchParam(searchParams, 'selected')"]) if (!resources.route.includes(required)) failures.push(`Conversations route state is missing ${required}`);
