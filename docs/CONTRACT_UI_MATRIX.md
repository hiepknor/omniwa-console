...
| `POST /conversations/{conversationRef}/archive` | instance | `conversation_app_state_commands` | command | conversations | deferred-product-workflow |
| `DELETE /conversations/{conversationRef}/archive` | instance | `conversation_app_state_commands` | command | conversations | deferred-product-workflow |
| `PUT /conversations/{conversationRef}/mute` | instance | `conversation_app_state_commands` | command | conversations | deferred-product-workflow |
| `DELETE /conversations/{conversationRef}/mute` | instance | `conversation_app_state_commands` | command | conversations | deferred-product-workflow |
| `POST /conversations/{conversationRef}/pin` | instance | `conversation_app_state_commands` | command | conversations | deferred-product-workflow |
| `DELETE /conversations/{conversationRef}/pin` | instance | `conversation_app_state_commands` | command | conversations | deferred-product-workflow |
| `POST /conversations/{conversationRef}/history-sync` | instance | `conversation_history_sync` | command | conversations | deferred-product-workflow |
