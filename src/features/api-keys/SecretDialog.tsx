...
export function SecretDialog({
  ...
  return (
    <ModalDialog titleId={titleId} eyebrow="Credential secret" title="API key secret — shown once" context={keyId} onClose={onClose} canClose={copied} initialFocusRef={copyRef} closeLabel="Close API key secret dialog" footer={<button className="btn primary max-[520px]:col-span-2 max-[360px]:col-span-1" type="button" onClick={onClose}>I stored the secret</button>}>
