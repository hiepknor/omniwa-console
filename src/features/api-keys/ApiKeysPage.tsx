...
function AdminApiKeysSurface() {
  ...
  return (
    <main className="settings-screen api-keys-screen">
      ...
      <DataTableWorkspace className="settings-keys" aria-labelledby="api-keys-table-title">
        <div className="settings-section-head"><div><h2>Admin key inventory</h2><p>Secrets are shown once after provision or rotation.</p></div><span className="settings-result-count num">{apiKeys.length} loaded keys</span></div>
        <DataTable
