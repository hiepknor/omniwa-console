...
export const conversationsFixture: ConversationResource[] = [
  { resourceType: 'conversation', conversationId: '4c2a5707-95f6-4565-87db-20d983bbd555', contactId: '9c37e2c7-875c-48ff-a298-00b853409cb1', aliases: ['15551230001@s.whatsapp.net', '731002@lid'], aliasesReported: true, addressingJid: '731002@lid', displayName: 'Anna Nguyen', displayNameSource: 'full_name', displayNameUpdatedAt: ago(900), type: 'direct', unreadCount: 2, unreadAuthoritative: true, lastActivityAt: ago(300), archived: false, pinned: true, disappearingTimer: 86_400 },
  { resourceType: 'conversation', conversationId: '2ab8f0b5-07d2-497f-a32d-0453ff16d347', aliases: ['15551230002@g.us'], aliasesReported: true, addressingJid: '15551230002@g.us', displayName: 'Support escalations', type: 'group', unreadCount: 0, unreadAuthoritative: false, lastActivityAt: ago(3600) },
  { resourceType: 'conversation', conversationId: 'd29075b2-3f27-45fb-b7ba-86455871cb53', contactId: 'b1277eeb-fccb-4909-a514-d4a3ca5f2a26', aliases: ['15551230003@s.whatsapp.net'], aliasesReported: true, addressingJid: '15551230003@s.whatsapp.net', displayName: 'David Tran', displayNameSource: 'push_name', type: 'direct', unreadCount: 5, unreadAuthoritative: true, lastActivityAt: ago(120) },
  { resourceType: 'conversation', conversationId: 'ea2e52c9-86ca-45af-ae63-337e24e60709', aliases: ['15551230004@newsletter'], aliasesReported: true, addressingJid: '15551230004@newsletter', displayName: 'Product updates', type: 'newsletter', unreadCount: 0, unreadAuthoritative: true, lastActivityAt: ago(86_400) },
  { resourceType: 'conversation', conversationId: 'ac90bd88-3629-43e3-87e9-a78d633d2dc5', aliases: ['15551230005@broadcast'], aliasesReported: true, addressingJid: '15551230005@broadcast', displayName: 'Operations broadcast', type: 'broadcast', unreadCount: 1, unreadAuthoritative: true, lastActivityAt: ago(172_800) },
];
...
export const messagesFixture: MessageResource[] = [
  { resourceType: 'message', id: 'msg_0', conversationId: previewConversationId, participantJid: '731002@lid', direction: 'incoming', type: 'text', createdAt: ago(172_800), provenance: 'history_sync' },
  { resourceType: 'message', id: 'msg_1', conversationId: previewConversationId, providerChatId: '731002@lid', participantJid: '15551230001@s.whatsapp.net', direction: 'incoming', type: 'text', status: 'read', contentText: 'Hi! Is my order shipped yet?', createdAt: ago(3000), provenance: 'live' },
  ...
  { resourceType: 'message', id: 'msg_4', conversationId: previewConversationId, direction: 'incoming', type: 'image', mediaType: 'image', mediaAssetId: 'asset_processing', contentSummary: 'Incoming image', status: 'delivered', createdAt: ago(900), provenance: 'live' },
  { resourceType: 'message', id: 'msg_5', conversationId: previewConversationId, direction: 'incoming', type: 'image', mediaType: 'image', mediaAssetId: 'asset_failed', contentSummary: 'Failed incoming image', status: 'delivered', createdAt: ago(700), provenance: 'live' },
