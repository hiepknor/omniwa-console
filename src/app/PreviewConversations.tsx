...
import { Button, Field, FilterToolbar, Input, PageHeader, SplitWorkspace, Status, Tabs, Textarea, WorkspacePaneHeader } from '@/ui';
        ...
        detail={
          <>
            <WorkspacePaneHeader
              ...
              actions={chat ? <Button className="hidden max-[900px]:inline-flex" onClick={() => setChatId(undefined)}>Back</Button> : undefined}
            />
          {chat ? <>
