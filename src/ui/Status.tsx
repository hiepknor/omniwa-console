...
export function Status({
  ...
  return (
    <span data-tone={tone} className={cn('inline-grid min-h-6 shrink-0 justify-self-start grid-cols-[20px_minmax(0,1fr)] items-stretch border border-line bg-surface align-middle text-[11px] font-medium leading-4 text-fg', wrap ? 'w-auto max-w-full' : 'w-max', tone === 'failed' && 'border-line-strong', className)}>
