...
describe('capabilities', () => {
  it('normalizes duplicate capability values without discarding unknown additions', async () => {
    const GET = vi.fn().mockResolvedValue({
      data: {
        ...
        data: {
          ...
          capabilities: ['groups_projection', 'canonical_contact_identity', 'canonical_conversation_identity', 'conversation_media_assets', 'future_projection', 'groups_projection'],
        },
      },
    ...
    expect(snapshot).toEqual({
      ...
      credentialScope: 'instance',
      instanceId: '0bca2c34-ef2a-463c-98fd-e2afb6978457',
      capabilities: ['canonical_contact_identity', 'canonical_conversation_identity', 'conversation_media_assets', 'future_projection', 'groups_projection'],
    });
