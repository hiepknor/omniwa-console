...
export function ModalDialog({
  ...
  return (
    ...
    >
      <div
        ref={dialogRef}
        className={`dialog modal-dialog !flex !max-h-[calc(100dvh-32px)] !w-[min(520px,calc(100vw-32px))] !flex-col !overflow-hidden !rounded-[var(--radius-md)] !border !border-[var(--border-strong)] !bg-[var(--surface)] !shadow-[var(--elev-raised)] max-[520px]:!max-h-[calc(100dvh-16px)] ${className}`}
        role="dialog"
        aria-modal="true"
